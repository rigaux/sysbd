...
class activity_duration(nodes.General, nodes.Element): pass
...
class Activity_duration(Directive):
    """
...
def setup(app):
    app.add_node(activity_duration, 
    ...
    app.add_directive("activity-duration", Activity_duration)
